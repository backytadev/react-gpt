...
import { GptMessageSelectableImage } from "@/presentation/components/chat-bubbles/GptMessageSelectableImage";
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      info: {
        alt: "Imagen base",
        imageUrl:
          "http://localhost:3000/gpt/image-generation/9e7fa2ae-ac2a-4f52-a34c-8c050fd7511d.png",
      },
    },
  ]);
